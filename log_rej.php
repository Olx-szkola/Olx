...
<html>
  ...
  <body>
          ...
          <input type="password" class="form-control" id="haslo" placeholder="Hasło" name="haslo">
      	 ...
      	 <input class="btn btn-primary btn_width btn_color" type="submit" id="submit" name="name" value="Zaloguj się">
     ...
     ?>
       <br>
      	<div class="space">
      	<input class="btn btn-primary btn_width btn_color" type="submit" class="name" value="Przejdz dalej">
      	 </div>
         <?php
    ...
    <a href="index.php" class="btn btn-outline-success btn_back"><i class="fas fa-chevron-right fas_left"></i>&nbsp;Strona główna</a>
  </div>
